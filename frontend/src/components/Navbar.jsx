      ...
      fontFamily: "'Montserrat', sans-serif"
       ...
       <div style={{ display: 'flex', gap: '5px', alignItems: 'center' }}>
         <Link to="/admin" style={{ display: 'flex', alignItems: 'center' }}>
           <img src="/img/MenúCuenta.png" alt="Cuenta" style={{ width: '40px', height: '40px' }} />
         </Link>

         <button style={{ background: 'none', border: 'none', cursor: 'pointer', padding: 0 }}>
           <img src="/img/MenúBuscar.png" alt="Buscar" style={{ width: '40px', height: '40px' }} />
         </button>

         <button onClick={() => setIsCartOpen(true)} style={{ background: 'none', border: 'none', cursor: 'pointer', position: 'relative', padding: 0 }}>
           <img src="/img/MenúCarrito.png" alt="Carrito" style={{ width: '40px', height: '40px' }} />
         ...
         <button onClick={() => setMenuOpen(!menuOpen)} style={{ background: 'none', border: 'none', cursor: 'pointer', padding: 0 }}>
           <img src="/img/MenúHamburguesa.png" alt="Menú" style={{ width: '40px', height: '40px' }} />
         </button>
       </div>
